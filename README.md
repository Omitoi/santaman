...
**Santaman** is a fast-paced, grid-based action game inspired by classic _Bomberman_ mechanics. Players step into the snowy boots of Santa (and his rivals) to drop explosive presents, blast away snowdrifts, and outsmart opponents in a battle for holiday supremacy.
...
_Controls for up to 4 players on a single device._
